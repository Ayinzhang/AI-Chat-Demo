...
namespace AIChatDemo
{
    public class STTManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (isRecording) { AppendNewMicData(); if (!Microphone.IsRecording(micDevice)) { StopStreaming(); return; } }
        ...
        public async Task InitModel()
        {
            ...
            if (whisper == null) { Debug.LogError("Failed to init Whisper model."); return; }
